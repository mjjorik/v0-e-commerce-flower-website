...
function wildflower_terms_starter() {
	...
	$p = array(
		...
		'<ul>',
		'<li><strong>' . esc_html__( 'Standard orders:', 'wildflower' ) . '</strong> ' . esc_html__( 'cancelled up to 48 hours before scheduled delivery are eligible for a full refund. Cancellations made less than 48 hours before delivery are not eligible for a refund.', 'wildflower' ) . '</li>',
		'<li><strong>' . esc_html__( 'Same-Day Delivery orders:', 'wildflower' ) . '</strong> ' . esc_html__( 'these orders are not eligible for cancellation or refund once placed, as flowers are purchased and preparation begins immediately.', 'wildflower' ) . '</li>',
		'<li><strong>' . esc_html__( 'Custom orders, grand arrangements, and event florals:', 'wildflower' ) . '</strong> ' . esc_html__( 'full refund available if cancelled within 3 hours of placing the order. After this window, these orders may be rescheduled to a new date or exchanged for store credit — cash refunds are not available.', 'wildflower' ) . '</li>',
		'</ul>',
		'<h2>' . esc_html__( 'Substitutions', 'wildflower' ) . '</h2>',
		'<p>' . esc_html__( 'Flowers are seasonal and natural. If a specific stem or container is unavailable, we may substitute an item of equal or greater value in a similar style and color, keeping the overall look and feel of the arrangement. If you decline the substitution, you may reschedule your delivery date, or cancel according to the terms above (full refund only within 3 hours of placing a custom order; otherwise reschedule or store credit).', 'wildflower' ) . '</p>',
